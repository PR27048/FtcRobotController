...
@Autonomous
public class Auto_Blue_Near_With_PedroPathing_Full_No_Gate extends OpMode {
    ...
    public enum PathState {
       ...
       // DRIVE_OPEN_GATE_SHOOT_POS,
        DRIVE_INTAKE_FIRST_ROW_POS_SHOOT_POS,
        SHOOT_2,
...
*/
        ...
        driveIntakeFirstRowPosShootPos = follower.pathBuilder()
                .addPath(new BezierLine(firstRowIntakeSetUpPose, shootPose))
                .setLinearHeadingInterpolation(firstRowIntakeSetUpPose.getHeading(), shootPose.getHeading())
                .build();
    ...
    public void statePathUpdate() {
        switch (pathState) {
            ...
            case DRIVE_FIRSTROW_INTAKE_SETUP_INTAKE_FIRSTROW:
                ...
                if (!follower.isBusy()) {
                    setPathState(PathState.DRIVE_INTAKE_FIRST_ROW_POS_SHOOT_POS);
                }
                break;
           ...
           /* case DRIVE_INTAKE_FIRSTROW_GATE_SETUP:
            ...
            case DRIVE_OPEN_GATE_SHOOT_POS:
                ...
                break;
*/
            case DRIVE_INTAKE_FIRST_ROW_POS_SHOOT_POS:
                if (!pathStarted) {
                    follower.followPath(driveIntakeFirstRowPosShootPos, true);
                    pathStarted = true;
                }
                if (!follower.isBusy()) {
                    setPathState(PathState.SHOOT_2);
